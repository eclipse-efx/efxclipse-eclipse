...
public class ParametersSwitch<@Nullable T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ParametersPackage.JVM_ARG: {
				JVmArg jVmArg = (JVmArg)theEObject;
			...
			case ParametersPackage.HTML_PARAM: {
				HtmlParam htmlParam = (HtmlParam)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>JVm Arg</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>JVm Arg</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseJVmArg(JVmArg object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Html Param</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Html Param</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHtmlParam(HtmlParam object) {
		return null;
	}
