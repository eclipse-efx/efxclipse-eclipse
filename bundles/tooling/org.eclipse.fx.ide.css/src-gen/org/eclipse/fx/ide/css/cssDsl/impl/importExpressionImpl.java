...
public class importExpressionImpl extends MinimalEObjectImpl.Container implements importExpression
{
  ...
  {
    return CssDslPackage.Literals.IMPORT_EXPRESSION;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CssDslPackage.IMPORT_EXPRESSION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CssDslPackage.IMPORT_EXPRESSION__VALUE:
        return getValue();
    }
