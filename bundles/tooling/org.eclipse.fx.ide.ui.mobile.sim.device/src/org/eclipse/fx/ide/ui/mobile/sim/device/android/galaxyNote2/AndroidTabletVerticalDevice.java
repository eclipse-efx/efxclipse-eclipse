...
public class AndroidTabletVerticalDevice extends BasicDevice {
	private static final String ROOT_URL = "org/eclipse/fx/ide/ui/mobile/sim/device/android/resources/galaxyNote2/vertical";
	
	public AndroidTabletVerticalDevice(double contentWidth, double contentHeight) {
	...
	protected BorderPane createContentPane() {
		...
		
		{
			...
			{
				Region r = new Region();
				r.setStyle("-fx-background-image: url('"+getIconUrl(ROOT_URL+"/10.png")+"'); -fx-background-repeat: repeat-y;");
		...
		
		{
			...
			{
				Region r = new Region();
				r.setStyle("-fx-background-image: url('"+getIconUrl(ROOT_URL+"/16.png")+"'); -fx-background-repeat: repeat-x;");
				HBox.setHgrow(r, Priority.ALWAYS);
				box.getChildren().add(r);
			}
